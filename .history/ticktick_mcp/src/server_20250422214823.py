...
async def get_project_tasks(project_id: str) -> str:
    ...
    try:
        ...
        # Add usage hint with example of actual task ID format
        result += "\nTo update a task, use the full ID shown above (e.g. 6247ee29630c800f064fd145) with the update_task command."
